...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link nav-link-1 active" aria-current="page" href="">Beranda</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item size-image">
                       ...
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Klik</h2>
                           <a href="{{route('detail', $i->id)}}">View more</a>
                       </figcaption>                    
                   </figure>
           ...
           @endforeach
               <!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-04.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Plants</h2>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-05.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Morning</h2>
                           <a href="{{asset('master/photo-detail.html')}}">View more</a>
                       </figcaption>                    
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-06.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Pinky</h2>
                           <a href="{{asset('master/photo-detail.html')}}">View more</a>
                       </figcaption>                    
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-01.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Hangers</h2>
                           <a href="{{asset('master/photo-detail.html')}}">View more</a>
                       </figcaption>                    
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-02.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Perfumes</h2>
                           <a href="{{asset('master/photo-detail.html')}}">View more</a>
                       </figcaption>                    
               ...
               <!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-07.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Bus</h2>
                           <a href="{{asset('master/photo-detail.html')}}">View more</a>
                       </figcaption>                    
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-08.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>New York</h2>
                           <a href="{{asset('master/photo-detail.html')}}">View more</a>
                       </figcaption>                    
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-09.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Abstract</h2>
                           <a href="{{asset('master/photo-detail.html')}}">View more</a>
                       </figcaption>                    
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-10.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Flowers</h2>
                           <a href="{{asset('master/photo-detail.html')}}">View more</a>
                       </figcaption>                    
               ...
               <!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-11.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Rosy</h2>
                           <a href="{{asset('master/photo-detail.html')}}">View more</a>
                       </figcaption>                    
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                   <figure class="effect-ming tm-video-item">
                       <img src="{{asset('master/img/img-12.jpg')}}" alt="Image" class="img-fluid">
                       <figcaption class="d-flex align-items-center justify-content-center">
                           <h2>Rocki</h2>
                           <a href="{{asset('master/photo-detail.html')}}">View more</a>
                       </figcaption>                    
   ...
   <span class="tm-text-gray-light">28 Aug 2020</span>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <img src="{{asset('master/img/img-13.jpg')}}" alt="Image" class="img-fluid">
                    <figcaption class="d-flex align-items-center justify-content-center">
                        <h2>Purple</h2>
                        <a href="{{asset('master/photo-detail.html')}}">View more</a>
                    </figcaption>                    
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <img src="{{asset('master/img/img-14.jpg')}}" alt="Image" class="img-fluid">
                    <figcaption class="d-flex align-items-center justify-content-center">
                        <h2>Sea</h2>
                        <a href="{{asset('master/photo-detail.html')}}">View more</a>
                    </figcaption>                    
            ...
            <!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <img src="{{asset('master/img/img-15.jpg')}}" alt="Image" class="img-fluid">
                    <figcaption class="d-flex align-items-center justify-content-center">
                        <h2>Turtle</h2>
                        <a href="{{asset('master/photo-detail.html')}}">View more</a>
                    </figcaption>                    
            ...
            <!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <img src="{{asset('master/img/img-16.jpg')}}" alt="Image" class="img-fluid">
                    <figcaption class="d-flex align-items-center justify-content-center">
                        <h2>Peace</h2>
                        <a href="{{asset('master/photo-detail.html')}}">View more</a>
                    </figcaption>                    
        ...
        <div class="container-fluid tm-container-small">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
                    ...
                    <p>Catalog-Z is free <a rel="sponsored" href="{{asset('master/https://v5.getbootstrap.com/')}}">Bootstrap 5</a> Alpha 2 HTML Template for video and photo websites. You can freely use this TemplateMo layout for a front-end integration with any kind of CMS website.</p>
                </div> -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-5 col-12 px-5 text-right">
                    Designed by <a href="{{asset('master/https://templatemo.com')}}" class="tm-text-gray" rel="sponsored" target="_parent">TemplateMo</a>
                </div>
            </div>
        </div>
    </footer> -->
